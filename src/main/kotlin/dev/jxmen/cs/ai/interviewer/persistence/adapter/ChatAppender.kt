...
import dev.jxmen.cs.ai.interviewer.common.utils.PromptMessageParser
...
class ChatAppender(
    ...
    private val promptMessageParser: PromptMessageParser,
    ...
    fun addAnswerAndNextQuestion(
        ...
        val score = promptMessageParser.parseScore(nextQuestion)

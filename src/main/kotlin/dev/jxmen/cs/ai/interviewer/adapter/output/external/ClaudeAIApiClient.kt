    ...
    companion object {
        fun create(
            ...
            val grantInterviewerContent =
                ...
                점수에 대한 기준은 다음과 같다. (0: 기초 부족, 10~30: 기초 수준만 아는 상태, 40~60: 어느 정도 알고 있음, 70~90: 어느 정도 깊게 알고 있음, 100: 매우 깊게 알고 있음)
                
                답변 형식은 다음과 같다.
                (매우 중요: 어떠한 답변을 해도 아래 형식을 반드시 맞출 것. 점수와 꼬리 질문은 정규식으로 추출하기 때문에 형식을 맞추지 않으면 정상적으로 추출되지 않을 수 있다.)
